...
describe("AuthController", () => {
  ...
  describe("googleAuth", () => {
    it("should authenticate with Google successfully", async () => {
      ...
      (AuthService.googleAuth as jest.Mock).mockResolvedValue(mockResult);
    ...
    it("should handle Google authentication error", async () => {
      ...
      (AuthService.googleAuth as jest.Mock).mockRejectedValue(error);
  ...
  describe("requestPasswordReset", () => {
    it("should request password reset successfully", async () => {
      ...
      (AuthService.requestPasswordReset as jest.Mock).mockResolvedValue(mockResult);
  ...
  describe("validateToken", () => {
    it("should validate a valid token successfully", async () => {
      ...
      (AuthService.validateToken as jest.Mock).mockResolvedValue(mockResult);
    ...
    it("should handle unexpected error during token validation", async () => {
      ...
      (AuthService.validateToken as jest.Mock).mockRejectedValue(error);
